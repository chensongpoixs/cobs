...
typedef send_video_callback recv_video_callback;
...
bool DLLIMPORT cpp_player_rtc_init();
void DLLIMPORT cpp_player_rtc_startup();
void DLLIMPORT cpp_player_rtc_destroy();
extern "C" {
...
///////////////////////////////PLAYER/////////////////////////////////////////////
bool DLLIMPORT c_player_rtc_init();
void  DLLIMPORT c_player_rtc_startup();
void DLLIMPORT c_player_rtc_destroy();
	////////////////////////publisher//////////////////////////////
//
